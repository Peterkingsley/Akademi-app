...
import { ArrowRight, CheckSquare, LockKeyhole, Mail, Phone, ShieldCheck, Square, User } from "lucide-react-native";
    ...
    <Screen hideHeader style={styles.screen}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroPanel}>
          ...
          <View style={styles.heroOrb}><ShieldCheck size={28} color="#050505" /></View>
        </View>
...
const styles = StyleSheet.create({
  ...
  heroPanel: { backgroundColor: "#101412", borderColor: "#1D3528", borderRadius: 28, borderWidth: 1, marginBottom: 16, minHeight: 168, overflow: "hidden", padding: 22 }, heroCopy: { maxWidth: "74%" }, headline: { ...typography.h1, color: "#FFFFFF", fontSize: 30, lineHeight: 36 }, subtext: { ...typography.body, color: colors.textSecondary, lineHeight: 20, marginTop: 8 }, heroOrb: { alignItems: "flex-start", backgroundColor: colors.primary, borderRadius: 56, bottom: -18, height: 112, justifyContent: "flex-start", paddingLeft: 20, paddingTop: 20, position: "absolute", right: -20, width: 112 },
