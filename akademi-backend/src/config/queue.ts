...
export const JOB_NAMES = {
  ...
  BUILD_COURSE_FLOOR: 'BUILD_COURSE_FLOOR',
  MODEL_TOPIC_PHASE_1: 'MODEL_TOPIC_PHASE_1',
  CLOSE_COURSE_GRAPH: 'CLOSE_COURSE_GRAPH',
  MODEL_TOPIC_PHASE_3: 'MODEL_TOPIC_PHASE_3',
  VALIDATE_MODEL_GATE_A: 'VALIDATE_MODEL_GATE_A',
} as const;
...
const BACKGROUND_JOB_NAMES = new Set<JobName>([
  ...
  JOB_NAMES.BUILD_COURSE_FLOOR,
  JOB_NAMES.MODEL_TOPIC_PHASE_1,
  JOB_NAMES.CLOSE_COURSE_GRAPH,
  JOB_NAMES.MODEL_TOPIC_PHASE_3,
  JOB_NAMES.VALIDATE_MODEL_GATE_A,
]);
