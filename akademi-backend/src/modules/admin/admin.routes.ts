...
router.get('/materials/:id/textbook-pdf', authorizeRoles(AdminRole.SUPER_ADMIN, AdminRole.CONTENT_MANAGER, AdminRole.MODERATOR), (req, res) => adminController.getGeneratedTextbookPdf(req, res));
...
router.post('/generated-textbooks/:outlineId/regenerate', authorizeRoles(AdminRole.SUPER_ADMIN, AdminRole.CONTENT_MANAGER), (req, res) => adminController.regenerateTextbook(req, res));
