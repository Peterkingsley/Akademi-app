...
router.post('/verify-email', authVerifyEmailRateLimiter, (req, res) => authController.verifyEmail(req, res));
...
router.post('/reset-password', authResetPasswordRateLimiter, (req, res) => authController.resetPassword(req, res));
router.post('/resend-verification', authResendVerificationRateLimiter, (req, res) => authController.resendVerification(req, res));
