...
import teachingEngineRoutes from './modules/teaching-engine/teaching-engine.routes';
...
import demoExamPrepRoutes from './modules/demo-exam-prep/demo-exam-prep.routes';
...
app.use('/teaching', teachingEngineRoutes);
...
app.use('/demo/exam-prep', demoExamPrepRoutes);
